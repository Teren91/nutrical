...
class FormulaFormTablet extends StatefulWidget {
  const FormulaFormTablet({super.key, required this.title});

  final String title;

  @override
  State<FormulaFormTablet> createState() => _FormulaFormTabletState();
}

class _FormulaFormTabletState extends State<FormulaFormTablet> {
  @override
            ...
            text: TextSpan(
              children: [
                ...
                TextSpan(
                    ...
                    style: Theme.of(context).textTheme.bodyMedium),
                TextSpan(
                    text: '3,64 + (suma de los 6 pliegues x 0.097)',
                    style: MyTheme().displaySmall),
                TextSpan(
